...
namespace Core.Migrations
{
    ...
    [Migration("20220707181546_addedFirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Model.CommonDropDown", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Model.ApplicationUser", b =>
                {
                    b.HasOne("Core.Model.CommonDropDown", "Gender")
                        .WithMany()
                        .HasForeignKey("GenderId");

                    b.HasOne("Core.Model.Country", "Nationality")
                        .WithMany()
                        .HasForeignKey("NationalityId");

                    b.HasOne("Core.Model.CommonDropDown", "Religion")
                        .WithMany()
                        .HasForeignKey("ReligionId");

                    b.HasOne("Core.Model.CommonDropDown", "School")
                        .WithMany()
